...
class CustomCalendarViewState extends State<CustomCalendarView> {
  ...
  void onDateClick(DateTime date) {
    if (startDate == null) {
      ...
      endDate = null;
    } else if (date.millisecondsSinceEpoch < startDate!.millisecondsSinceEpoch) {
      startDate = date;
    } else if (date.millisecondsSinceEpoch > startDate!.millisecondsSinceEpoch && date.millisecondsSinceEpoch < endDate!.millisecondsSinceEpoch){
      endDate = date;
    }
    if (startDate == null && endDate != null) {
      startDate = endDate;
